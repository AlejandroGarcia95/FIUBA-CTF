...
$servers->setValue('server','name','vulnerable.strm.sh');
...
$servers->setValue('server','base',array('dc=vulnerable,dc=strm,dc=sh'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
   ...
   binds. */
$servers->setValue('login','bind_id','cn=David Benioff,cn=users,dc=vulnerable,dc=strm,dc=sh');
#  $servers->setValue('login','bind_id','cn=Manager,dc=example,dc=com');

/* Your LDAP password. If you specified an empty bind_id above, this MUST also
   be blank. */
$servers->setValue('login','bind_pass','targaryen');
